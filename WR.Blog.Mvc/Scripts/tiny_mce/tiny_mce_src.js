...
(function(win) {
    ...
    var tinymce = {
        ...
        _init : function() {
            ...
            function getBase(n) {
                //RS: workaround for ASP.NET bundle : requires bundle-name ending with "_js" instead of ".js" eg:tiny_mce_js
                //original:
                //if (n.src && /tiny_mce(|_gzip|_jquery|_prototype|_full)(_dev|_src)?.js/.test(n.src)) {
                if (n.src && /tiny_mce(|_gzip|_jquery|_prototype|_full)(_dev|_src)?(.js|_js)/.test(n.src)) {
